...
const myHamburger = new Hamburger(Hamburger.SIZE_SMALL, [
...
console.log(
  "Ціна гамбургера після додавання опцій: " +  myHamburger.calculatePrice() +     " тугриків"
);
console.log(
  "Калорійність гамбургера після додавання опцій: " +     myHamburger.calculateCalories() +     " калорій"
);
